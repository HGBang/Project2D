...
void CComponentWindow::TreeCallback(CEditorTreeItem<class CComponent*>* Node, const std::string& Item)
{
	...
	CDetailWindow* DetailWindow = CEditorGUIManager::GetInst()->CreateEditorWindow<CDetailWindow>("DetailWindow");
	...
	/*	if (m_SelectComponent->GetName() == "sprite")
		{
			CTextureWindow* TextureWindow = CEditorGUIManager::GetInst()->CreateEditorWindow<CTextureWindow>("TextureWindow");
		}*/
