...
bool CMaterialManager::Init()
{
	...
	Material->SetShader("TileMapShader");
	Material->AddTexture(0, (int)EShaderBufferType::Pixel, "DefaultTileRect", TEXT("Floors.png"));
	Material->SetRenderState("DepthLessEqual");
    Material->SetRenderState("AlphaBlend");
	...
	Material->AddTexture(0, (int)EShaderBufferType::Pixel, "Henesis", TEXT("Henesis.png"));
	Material->SetRenderState("DepthLessEqual");


	Material = CreateMaterial<CMaterial>("MouseMaterial");
	Material->SetShader("MouseShader");
	Material->AddTexture(0, (int)EShaderBufferType::Pixel, "Mouse", TEXT("Cursor.png"));
	Material->SetRenderState("AlphaBlend");
