...
private:
	...
	class CEditorInput* m_FrameTileFolderName;
	class CEditorInput* m_FrameTileImageName;
	class CEditorInput* m_FrameTileCount;
...
private:
	...
	void SetTileTextureButton();
	void SetTileArrayTextureButton();
	void TileAllDeleteButton();
	void TileBackTextureChangeButton();
};
